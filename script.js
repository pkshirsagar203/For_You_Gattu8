...
function drawText() {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          ...
          "all the time and space in the universe can contain my dear Gattu i love you baacha ",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
      ...
      context.fillText(
        "I love you so much baacha you are the best sona , more than all the time and space in the universe can contain",
        canvas.width / 2,
        canvas.height / 2
      );
    }
  ...
  if (frameNumber >= 3600 && frameNumber < 99999) {
    ...
    context.fillText(
      "Will You Be Mine?  Happy propose day sona",
      canvas.width / 2,
      canvas.height / 2 + 120
    );
